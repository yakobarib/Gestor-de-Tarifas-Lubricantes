...
const ExcelReader = (() => {
  ...
  function read(arrayBuffer, filename) {
    ...
    throw new Error('No se reconoce el formato de esta tarifa. Proveedores soportados: Repsol, AD Parts (Normal / Standard / Sport Car / Químicos), Eni Live, Racing Oil y Shell.');
  }
